            //************* Hardware ******************
#define       s1602_dat    PORTA5_bit
#define       s1602_sck    PORTA6_bit
#define       s1602_DDRdat    DDA5_bit
#define       s1602_DDRsck    DDA6_bit
...
void          s595_cargar(char cargar_dat)
{
                          ...
                          s1602_sck = 1;
                          delay_us(1);
                      //    s1602_sck = 0;       //dejar clk en uno y genero el latch
                          delay_us(20);
...
void          hardware_init()
{
                   s1602_DDRsck = 1;     //1-salida 0-entrada
                   s1602_DDRdat = 1;     //1-salida 0-entrada
                   s1602_sck = 0;
                   s1602_dat = 0;
